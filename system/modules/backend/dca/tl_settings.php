...
class tl_settings extends Backend
{
	...
	public function checkUploadPath($varValue)
	{
		...
		if (preg_match('@^(typolight|contao|plugins|system|templates|)(/|$)@', $varValue))
		{
